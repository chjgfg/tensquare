...
/*  public void thumbupById(String id){
    Spit byId = findById(id);
    byId.setThumbup(byId.getThumbup() == null ? 1 : byId.getThumbup()+1);
    spitDao.save(byId);
  }*/
  ...
  public void thumbupById(String id){
    ...
    querys.addCriteria(Criteria.where("_id").is(id));
    mongoTemplate.remove(querys,"spit");*/
  }
